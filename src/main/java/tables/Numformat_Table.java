...
public class Numformat_Table {
	...
	public static void create_map() {
		...
		_hashmap.put("Ò», ¶þ, Èý, ...","chinese-counting.Ò» ¶þ Èý ËÄ Îå Áù Æß °Ë ¾Å ");
		_hashmap.put("Ò¼, ·¡, Èþ, ...","chinese-legal-simplified.Ò¼ ·¡ Èþ ËÁ Îé Â½ Æâ °Æ ¾Á ");
		_hashmap.put("¼×, ÒÒ, ±û, ...","ideograph-traditional.¼× ÒÒ ±û ¶¡ Îì ¼º ¸ý ÐÁ ÈÉ ");
