...
public class Anchor_Pos {
	...
	private static Map<String,Float> _colStartX_map = new HashMap<String,Float>();  //������ʼx���� 
	private static float _nextColStartX = 0;  //������ʼx����
	private static float _currentRowStartY = 0;  //��ǰ����ʼy����

	private static int _colIndex = 1;
	private static float _rowHeightAdd = 0;
	private static String _tableName = "";
	private static final float _DEFcolWidth = (float)85.6926;  //Ĭ�ϵ�Ԫ����(��ͼ�α���2.267*37.8)
